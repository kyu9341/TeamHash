...
public class ChatController {
  ...
  public String index(Model model,@PathVariable("nickname") String nickname, @PathVariable("title") String title){
  ...
  public Chat chat(@DestinationVariable Long projectId, Chat chat, 
    ...
    chatservice.saveChat(chat,account); // 전송 전 DB에 저장
